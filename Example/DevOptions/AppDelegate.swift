...
//  Copyright (c) 2019 Nomade Solutions Mobiles. All rights reserved.
//
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    /*
     * Everything in this project has been simplified to image basic cases
     */
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if application.applicationState != .background {
            ...
            window?.rootViewController = BaseNavigationController(rootViewController: WelcomeViewController())
        ...
        DevOptions.configure(configurations, baseUrls: [UIApplication.serverBaseUrl(), UIApplication.otherBaseUrl()]) {
            if SettingsCenter.shared().isConnected {
                ...
                DevOptions.showUserDisconnectedAlert()
                
            } else if SettingsCenter.shared().needsToReset {
                DevOptions.showRestartAlert()
            }
